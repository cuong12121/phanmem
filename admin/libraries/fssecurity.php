...
class FSSecurity
{
	...
	static function check_permission_groups($module,$view,$task){
		...
		if($task == 'prints' && $_SESSION['ad_userid'] == 266 || $module == 'print_history' && $_SESSION['ad_userid'] == 266 && $task=='display'||$module == 'packages' && $_SESSION['ad_userid'] == 266||$module == 'order' && $_SESSION['ad_userid'] == 266||$module == 'products' && $_SESSION['ad_userid'] == 266||$module == 'products' && $task == 'SearchBYNamePD'){
			return true;
		}
