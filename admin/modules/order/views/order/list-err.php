...
<table class="table-responsive">
        ...
        <?php 
            ...
            function convertContentCheck($content){
                ...
                // if(empty($b[0])){
                 preg_match_all('/[A-Z-0-9]{1}[A-Za-z0-9]{1}[A-Za-z0-9]{1}[A-Za-z0-9]{1}+\s*-\s*[A-Za-z0-9][A-Za-z0-9][A-Za-z0-9][A-Za-z0-9][A-Za-z0-9][A-Za-z0-9][A-Za-z0-9][A-Za-z0-9][A-Za-z0-9]+-[A-Za-z0-9]+-[A-Za-z0-9][A-Za-z0-9][0-9]/', $content, $b);
                }
